...
public class AlternativeCurrenciesRepositoryAspect {
    @Before("this(com.spring.professional.exam.tutorial."
    		+ "module02.question02.bls.AlternativeCurrenciesRepository)")
    public void beforeThisCurrenciesRepository() {
        System.out.println("Before - this(AlternativeCurrenciesRepository)");
    }

    @Before("target(com.spring.professional.exam."
    		+ "tutorial.module02.question02.bls.AlternativeCurrenciesRepository)")
